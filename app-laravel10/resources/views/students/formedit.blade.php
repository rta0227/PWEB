        ...
        <div class="card-body">
            ...
            <form method="POST" action="{{ url('students/'.$txtid) }}">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control-plaintext" name="txtid" value="{{ $txtid }}">
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-4">
                        <select class="form-select form-select-sm @error('txtgender') is-invalid @enderror" name="txtgender"
                            id="txtgender">
